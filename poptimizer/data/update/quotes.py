...
from poptimizer.data.update import securities, validate
...
class Service:
    ...
    @DataUpdateError.wrap_errors("can't update quotes")
    @DataUpdateError.retry_on_error(logging.getLogger("Quotes"))
    async def _download(
        self,
        ...
        match sec.board:
            ...
            case _:
                raise DataUpdateError(f"unknown board {sec.board} for ticker {sec.ticker}")
