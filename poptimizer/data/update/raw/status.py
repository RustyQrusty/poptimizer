...
from poptimizer.adapters import portfolio
from poptimizer.core import domain, exceptions, repository
...
class Service:
    ...
    @exceptions.DataUpdateError.suppress_errors(logging.getLogger("Status"))
    ...
    async def _update(self, update_day: datetime, sec: list[securities.Security]) -> list[Status]:
        ...
        selected = set(await self._portfolio_adapter.tickers())
